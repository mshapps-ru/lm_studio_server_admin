- **Step 1:** Add new Models tab in `wwwroot/index.html` between Home and Settings. (DONE) (DONE)
- **Step 2:** Create a dedicated JavaScript module `wwwroot/js/models.js` that: (DONE)
...
- **Step 3:** Add UI controls to edit default parameters: (DONE)
...
- **Step 4:** Backend API changes: (DONE)
...
- **Step 5:** Ensure authentication checks (same as other API endpoints). All new routes should be under `/api/` and require a valid auth token. (DONE)
