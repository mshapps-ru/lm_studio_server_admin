...
- **ConfigManager** – Persist configuration (username, password hash, port, LM Studio port, bind address, and verbose logging flag) in `config.json` located next to the executable.
